...
class Particle {
    ...
    draw() {
        ...
        image(currentIcon, 0, 0, size, size);
        pop();
    }
    interact(other) {
...
function setup() {
    ...
    icon1 = createImg("./images/icon1.svg", "icon1");
    icon2 = createImg("./images/icon2.svg", "icon2");
    icon1.hide();
    icon2.hide();
    frameRate(60);
...
function draw() {
    background("#fff");
    deltaTime = constrain(window.deltaTime / 1000, 0.001, 0.033);
